...
<body>
  ...
  <div class="login-container">
    <form id="hotelLoginForm">
      ...
      <input type="date" id="sat" name="arrivalDate" required>

      <label for="name">Name:</label>
      <input type="text" id="sat" name="name" required>

      <label for="email">E-mail:</label>
      <input type="email" id="wat" name="email" required>
      ...
      <select id="vat" name="roomType" required>
      ...
      <input type="date" id="bat" name="departureDate" required>
